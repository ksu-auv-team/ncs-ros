...
LABELS = ("background", "path_marker", "start_gate", 
            "channel", "claw", "die1", "die2", "die5", "die6", 'roulette_wheel', 'red_wheel_side', 'black_wheel_side',
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        print(img_counter)
        img_counter += 1
        cv2.imwrite('/home/owl/src/ncs-ros/raw_out/'+str(img_counter)+'.jpg', image)
        #run network
        output = run_inference(image, graph, inputfifo, outputfifo)
        #message will be in format described above
        msg = Float32MultiArray()
        ...
        cv2.imwrite('/home/owl/src/ncs-ros/out_imgs/'+str(img_counter)+'.jpg', image)
